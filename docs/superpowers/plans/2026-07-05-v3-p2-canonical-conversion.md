...
- [ ] **Step 4: profiles/*/contributes.json を作成**
...
- [ ] **Step 2: README.md を v3 構成の説明に書き換え**
...
- [ ] **Step 3: ローカルで v3 validate を実行して 0 エラー確認**
...
- [ ] **Step 2: CI validate green を確認**(v3 経路で走ることをログで確認)

- [ ] **Step 3: ユーザー merge 後の観測**
...
- [ ] canonical-files が catalog/profiles/templates 構成のみになり、CI validate(v3 経路)green
- [ ] merge 前: 16 組合せの FileChange 等価(renovate 新規作成のみ意味的同一)を実測
- [ ] merge 後: 全リポ 0 diff(no-op 収束)を観測
- [ ] spec v3 DoD-1(既存配布物の描画結果が v2 と意味的に同一)達成
